/* ════════════════════════════════════════════════════════════════════════
   ...
   wsu-eit-a11y.js · v10 · Enrollment Information Technology · 2026-06-11
   ...
   lines. Current count: 9 features (A1–A9).
     ...
     A1 date-part selects get Month/Day/Year names (backstop — Slate names
        them natively today; verified 2026-06-10)
     ...
     A4 controls in required questions get aria-required="true" + a live
        "still blank" class that drives the crimson left-edge hint in CSS
